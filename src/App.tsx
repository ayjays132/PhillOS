...
import TimeAI from './apps/timeai';
import GenLab from './apps/genlab';
import ConverseAI from './apps/converseai';
import InBoxAI from './apps/inboxai';
import WebLens from './apps/weblens';
import MediaSphere from './apps/mediasphere';
import SoundScape from './apps/soundscape';
import VisionVault from './apps/visionvault';
import SecureCore from './apps/securecore';
import AppForge from './apps/appforge';
import SpaceManager from './apps/spacemanager';
import PulseMonitor from './apps/pulsemonitor';
import BrainPadApp from './apps/brainpad';
import { ProtonLauncher } from './components/ProtonLauncher';
import PhoneApp from './components/PhoneApp';
import { AgentConsole } from './components/AgentConsole';
import { OnboardingStepper } from './components/onboarding/OnboardingStepper';
import { ConversationalSettingsView } from './apps/settings/ConversationalSettingsView';
import PhoneSettingsView from './apps/settings/PhoneSettingsView';
import MemorySettings from './components/MemorySettings';
import MemoryHub from './components/MemoryHub';
import SettingsApp from './apps/settings';
import CursorSettingsView from './apps/settings/CursorSettingsView';
import ControlPanel from './apps/settings/ControlPanel';
import SettingsLayout from './apps/settings/SettingsLayout';
import SettingsHome from './apps/settings/SettingsHome';
