...
import { Settings, Files, BotMessageSquare, LayoutGrid, MonitorPlay, Mail, BrainCircuit, Phone, Package } from 'lucide-react';
...
const DEFAULT_ITEMS: NavItem[] = [
  ...
  { id: 'appforge', label: 'AppForge', path: '/appforge', icon: Package },
